...
import com.yan.dd_common.utils.DateUtils2;
...
public class LocalFileServiceImpl implements LocalFileService {
    ...
    public String uploadPictureByUrl(String itemUrl, FileSort fileSort) {
        ...
        //文件绝对路径
        String newPath = path + sortUrl + "/jpg/" + DateUtils2.getYears() + "/"
                + DateUtils2.getMonth() + "/" + DateUtils2.getDay() + "/";

        //文件相对路径
        String fileUrl = sortUrl + "/jpg/" + DateUtils2.getYears() + "/"
                + DateUtils2.getMonth() + "/" + DateUtils2.getDay() + "/" + newFileName;
    ...
    private String uploadSingleFile(MultipartFile multipartFile, FileSort fileSort) throws IOException {
        ...
        String newPath = path + sortUrl + "/" + picExpandedName + "/" + DateUtils2.getYears() + "/"
                + DateUtils2.getMonth() + "/" + DateUtils2.getDay() + "/";

        String picurl = sortUrl + "/" + picExpandedName + "/" + DateUtils2.getYears() + "/"
                + DateUtils2.getMonth() + "/" + DateUtils2.getDay() + "/" + newFileName;
        String saveUrl = newPath + newFileName;

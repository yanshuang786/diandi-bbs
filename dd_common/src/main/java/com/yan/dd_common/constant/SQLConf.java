...
/**
 * @author yanshuang
 * @date 2023/4/12 19:01
 */
public class SQLConf extends BaseSQLConf {


    /**
     * FileSort表
     */
    public final static String BLOG_SORT_UID = "blog_sort_id";
    public final static String RESOURCE_SORT_UID = "resource_sort_uid";
    public final static String TAG_UID = "tag_id";
    ...
    public final static String ADMINUID = "admin_id";
    ...
    public final static String IS_AUDIT = "is_audit";
    ...
    public final static String BLOG_UID = "blog_id";
    ...
    public static final String FIRST_COMMENT_UID = "first_comment_id";
}
